...
//Nesting struct of other structs
typedef struct ST_transaction_t
{
	ST_cardData_t cardHolderData; //name an object of each struct
	ST_terminalData_t terminalData;
	EN_transState_t transState; //state is approved or denied
